...
<div class="col-lg-12">
	...
	<div class="row">
		<div class="col-md-12 mb-2">
			<button class="btn bg-light border float-right" type="button" id="share"><i class="fa fa-share"></i> Compartir este documento</button>
		</div>
	</div>
    <?php endif; ?>
	<div class="row">
				...
				<div class="card-header">
					<div class="card-tools">
						<small class="text-muted">
							Fecha de Subida: <?php echo date("M d, Y",strtotime($date_created)) ?>
						</small>
					</div>
				</div>
				<div class="card-body">
		...
		<div class="col-md-5">
			<div class="card card-outline card-primary">
				...
				<div class="card-body">
					<div class="col-md-12">
						<div class="alert alert-info px-2 py-1"><i class="fa fa-info-circle"></i> Clic en el archivo para descargar</div>
						<div class="row">
							 <?php
