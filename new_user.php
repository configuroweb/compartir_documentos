			...
			<form action="" id="manage_user">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							<label for="" class="control-label">No. de Contacto</label>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<label for="" class="control-label">Roles de Usuario</label>
							<select name="type" id="type" class="custom-select custom-select-sm">
								<option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>Usuario</option>
