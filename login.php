...
<head>
  ...
  <title>Login | Sistema Gestor de Documentos en Línea en PHP y MySQL</title>
...
<body class="bg-dark">
  ...
  <main id="main" >
		...
		<h4 class="text-white text-center"><b>Sistema Gestor de Documentos en Línea en PHP y MySQL</b></h4>
