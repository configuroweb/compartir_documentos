	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_document"><i class="fa fa-plus"></i> Agregar Nuevo</a>
			</div>
		</div>
		<div class="card-body">
				...
				<tbody>
					...
					<tr>
						...
						<td><b class="truncate"><?php echo strip_tags($desc) ?></b></td>
						  <?php if($_SESSION['login_type'] == 1 ): ?>
						<td><?php echo isset($uname[$row['user_id']]) ? $uname[$row['user_id']] : "Usuario Eliminado" ?></td>
					    <?php endif; ?>
...
<script>
	...
	_conf("¿Estás segur@ de eliminar este documento?","delete_document",[$(this).attr('data-id')])
	})
	})
